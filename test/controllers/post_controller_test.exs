defmodule ElixirFriends.PostControllerTest do
  ...
  test "shows an image for the post", %{conn: conn} do
    post = Repo.insert! %Post{image_url: "https://pbs.twimg.com/profile_images/609031092478308352/vBABv4Wy_400x400.jpg"}
    conn = get conn, post_path(conn, :show, post)
    assert html_response(conn, 200) =~ "Show post"
    assert html_response(conn, 200) =~ "<img src='https://pbs.twimg.com/profile_images/609031092478308352/vBABv4Wy_400x400.jpg' />"
  end
